 ...
 *
 * Literal objects are the DI contract. The strategy map callback mounts
 * complete authentication strategies under
...
/**
 * Authentication constructor. Session adapter first, strategy map callback second.
 *
 ...
 * core never enumerates. The returned namespaces preserve their exact
 * configured types.
 */
